...
import { saveToken, saveUserInfo, removeToken, removeUserInfo, getToken, getUserInfo } from '../../utils/storage';
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginUserThunk.fulfilled, (state, action: PayloadAction<FrontendUser>) => {
        state.isLoading = false;
