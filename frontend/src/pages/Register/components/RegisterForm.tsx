...
import { registerUserThunk, clearAuthError } from '../../../features/auth/authSlice';
    ...
    <form className={styles.registerForm} onSubmit={handleSubmit}>
      ...
      />
       ...
       <div className={styles.formGroup}>
         ...
         <input type="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} required minLength={6} disabled={isLoading} />
       </div>
